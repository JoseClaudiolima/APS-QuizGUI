...
public class Aleatorio {
    ...
    // Isso pois quando era gerado aleatoriamente a questao 0 (a primeira questao)
    // estava dando conflito com "new int[30]" que já colocava as 30 questões como 0
    public Aleatorio() {
    ...
    public int getQuestaoAleatoria(String Dificuldade) {
        ...
        // De acordo com a dificuldade, o range muda, por exemplo: Questões fáceis estão
        // entre a 1° e a 10° questão, e as Díficeis entre a 20° e a 30°
        ...
        // Aqui gerará um numero da questão aleatório enquanto esse numero não for igual
        // ao outros anteriores escolhidos, isso é para a questão não ser repetida
        // várias vezes por razão de ter pego de forma aleatória.
        do {
        ...
        // Abaixo, Armazenará a questão escolhida a uma lista, na ordem que foram
        // escolhidas
    ...
    // Esse metódo colocará a questão que foi escolhida pelo método aleatório, na
    // ordem que for dita
    ...
    // Esse método verifica se a questão escolhida pelo método aleatório já foi
    // escolhida ou não
