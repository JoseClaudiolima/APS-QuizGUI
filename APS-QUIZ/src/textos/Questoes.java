...
public class Questoes {
    ...
    public String[] todasPerguntasArray = {
        ...
        "(QUESTÃO MÉDIA) \n5- Dizem que o efeito estufa é balela... Eu sei, parece bobo achar isso né? Até porque na nossa vizinhança estelar temos um ótimo exemplo\n de como a Terra pode ficar se nada for feito a respeito. Então, qual seria ele?\n"
        + "\na) Júpter.\n"
        + "b) Marte.\n"
        + "c) Mercúrio.\n"
        +"d) Vênus.",
        ...
        "(QUESTÃO MÉDIA) \n7- Plantas são a base da cadeia alimentar, e por isso é importante entender para cuidar e preservar a flora. As plantas sintetizam sua energia,\n ou seja, produzem seu próprio alimento, através da captação da luz solar num processo químico. Parte da luz que não é absorvida é refletida\n na faixa de cor verde, característica comum das folhas.\n Com isso, qual é o processo químico descrito e o que é responsável pela captação da luz solar?\n"
        ...
        "(QUESTÃO MÉDIA) \n8- Todos nós contribuímos indiretamente ou diretamente pra o efeito estufa, seja assistindo televisão, tomando banho, comendo um pacote\n de biscoito (bolacha?), andando de carro... e por ai vai. Todas essas atividades envolveram ou envolvem de alguma forma alguma ação que\n agride o meio ambiente, como o uso de combustíveis fósseis ou a poluição de lençóis freáticos, apenas consumindo.\n Para ajudar a conscientizar as pessoas em todas as feras, criou-se um termo, que nos diz qual o nosso impacto no ambiental:\n"
        + "\na) Carbono zero.\n"
        + "b) Sustentabilidade.\n"
        + "c) Aspecto do carbono.\n"
        +"d) Pegada de carbono.",

        "(QUESTÃO MÉDIA) \n9- É de grande urgência que a humanidade trilhe um caminho mais limpo ao tratar de fontes energéticas. Opções não faltam!\n Dentre as que estão abaixo, qual é a fonte de energia renovável considerada a mais limpa?\n"
        + "\na) Eólica.\n"
        + "b) Solar.\n"
        + "c) Biomassa.\n"
        +"d) Hidrelétrica.",

        "(QUESTÃO DIFÍCIL) \n10- O efeito estufa, fenômeno de aquecimento acelerado da atmosfera terrestre, possui seus vilanescos causadores, os GEEs, ou gases do efeito estufa.\n O maior contribuinte nasce do uso de combustíveis fósseis e atividade industrial, mas não é necessariamente o mais potente.\n O segundo maior contribuinte é mais potente e advém principalmente da extração de petróleo, carvão e atividade pecuária com uso de animais ruminantes.\n O terceiro maior culpado é ainda menos contribuinte e mais potente, fruto da atividade agrícola com uso de agrotóxicos e químicos no cultivo.\n Dadas as informações, quais são esses 3 GEEs, respectivamente?\n"
        ...
        "(QUESTÃO DIFÍCIL) \n11- Qual o nome do processo que descreve um escoamento de água na camada superficial do solo, causado por intensas chuvas, que transporta\n os nutrientes do solo a áreas mais baixas, levando ao empobrecimento da terra? \n"
        + "\na) Osmose.\n"
        + "b) Infiltração.\n"
        + "c) Lixiviação.\n"
        +"d) Erosão."
