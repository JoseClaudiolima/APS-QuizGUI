...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        while (contador <5){
            ...
            int questao  = Interface.getQuestão(questoes.getPergunta(QuestaoFacil) , "Dificuldade: Fácil",questoes.getDica(QuestaoFacil));
            questao = Interface.getAlternativas(questoes.getAlternativaIsolada(QuestaoFacil,0), questoes.getAlternativaIsolada(QuestaoFacil,1), questoes.getAlternativaIsolada(QuestaoFacil,2), questoes.getAlternativaIsolada(QuestaoFacil,3), questoes.getPergunta(QuestaoFacil),"Dificuldade: Fácil");
        ...
        while (contador <10){
            ...
            //Mostrará uma Interface, pegando os dados da classe "Questões"
            int questao  = Interface.getQuestão(questoes.getPergunta(QuestaoMedia), "Dificuldade: Média",questoes.getDica(QuestaoMedia));
            questao = Interface.getAlternativas(questoes.getAlternativaIsolada(QuestaoMedia,0), questoes.getAlternativaIsolada(QuestaoMedia,1), questoes.getAlternativaIsolada(QuestaoMedia,2), questoes.getAlternativaIsolada(QuestaoMedia,3), questoes.getPergunta(QuestaoMedia),"Dificuldade: Média");
        ...
        while (contador <15){
            ...
            //Mostrará uma Interface, pegando os dados da classe "Questões"
            int questao  = Interface.getQuestão(questoes.getPergunta(QuestaoDificil), "Dificuldade: Dificil",questoes.getDica(QuestaoDificil));
            questao = Interface.getAlternativas(questoes.getAlternativaIsolada(QuestaoDificil,0), questoes.getAlternativaIsolada(QuestaoDificil,1), questoes.getAlternativaIsolada(QuestaoDificil,2), questoes.getAlternativaIsolada(QuestaoDificil,3), questoes.getPergunta(QuestaoDificil),"Dificuldade: Dificil");
